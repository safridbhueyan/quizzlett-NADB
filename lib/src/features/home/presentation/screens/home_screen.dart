            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      // Navigate to space challenge directly
                      final spaceCategory = categories.firstWhere(
                        (cat) => cat.id == 'space-astronomy',
                        orElse: () => categories.first,
                      );
                      ref.read(quizControllerProvider.notifier).startQuiz(spaceCategory);
                      context.push('/quiz/${spaceCategory.id}');
                    },
                    borderRadius: BorderRadius.circular(24),
                    child: Ink(
                      padding: const EdgeInsets.all(20),
